...
namespace atomic_dex
{
    ...
    struct kdf_config
    {
        ...
        std::vector<std::string> seednodes{"seed02.kmdefi.net", "seed04.kmdefi.net", "sintara.dragon-seed.com", "160.191.224.187", "mm2seed.shorelinecrypto.com", "seed01.netid8762.fans", "seed02.netid8762.fans"};
#ifdef _WIN32
